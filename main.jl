...
function run_det(processed_data, forecast_data, d_train_set, moving_day, test_day_2023,acceptance_criteria_factor,gamma)
...
function run_sto(processed_data, forecast_data, d_train_set, moving_day,gamma, size_W1, size_W2, size_W3, test_day_2023,acceptance_criteria_factor)
    #Stochastic Model
    Data_index = Define_Training_and_Test_index(d_train_set, moving_day)
    data_sto = data_import_stochastic(processed_data, forecast_data, Data_index,gamma, size_W1, size_W2, size_W3,false,false,"With forecast in input")
...
function run_feature(processed_data, forecast_data, Architecture, d_train_set, moving_day,gamma, test_day_2023, scaling,acceptance_criteria_factor)
    #Feature Model
...
function run_all(Models_range, d_train_set_range, moving_day_range,forecast_range,gamma_range,acceptance_criteria_factor_range,out_of_sample, scaling, save_all)
    #Fixed parameters
                    ...
                    for test_day_2023 in test_day_2023_range
                        ...
                        for acceptance_criteria_factor in acceptance_criteria_factor_range                        
                            ...
                            if issubset(["det"],Models_range)  == true
                                result_det = run_det(processed_data, forecast_data, d_train_set, moving_day, test_day_2023,acceptance_criteria_factor,gamma)
                            ...
                            if issubset(["sto"],Models_range) == true
                                result_sto = run_sto(processed_data, forecast_data,d_train_set, moving_day,gamma, size_W1, size_W2, size_W3, test_day_2023,acceptance_criteria_factor)
                            ...
                            if issubset(["feature"],Models_range)  == true
                                ...
                                for Architecture in Architectures
                                    ...
                                    result_feature = run_feature(processed_data, forecast_data, Architecture , d_train_set, moving_day,gamma, test_day_2023, scaling,acceptance_criteria_factor)
...
RT_profit, Exp_profit = run_all(Models_range,d_train_set_range, moving_day_range,forecast_range,gamma_range,acceptance_criteria_factor_range, out_of_sample, scaling, save_all)

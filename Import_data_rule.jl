...
function data_import_Rule(forecast_data,Data_index)
    ...
    ### RESHAPE 
    Spot = reshape(forecast_data[forecast_idx,"Spot"], (24, 1))
    FD2_down = reshape(forecast_data[forecast_idx,"FD2_down"], (24, 1))
    FD2_up = reshape(forecast_data[forecast_idx,"FD2_up"], (24, 1))
